...
router.post('/', secure('valid'), secure('vendor-deliver'), upsert);
router.put('/', secure('valid'), secure('vendor-deliver'), upsert);
router.delete('/:id', secure('valid'), secure('vendor-deliver'), remove);
